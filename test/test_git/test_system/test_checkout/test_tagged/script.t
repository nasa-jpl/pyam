...
#--------------------------------------------------------------------------------
    $ echo '====== CHECKING OUT MyNewGitModule-R1-00 tagged release'
    ====== CHECKING OUT MyNewGitModule-R1-00 tagged release
...
#Fill in YAM.config
	...
	# Check current branch. Should be none since we are on a tag.
