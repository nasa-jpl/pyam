...
#$ git -P -C $repo_dir tag
    ...
    * main
	...
	# No remote branches here since this is the main repository
...
# run save command
    ...
    $ ls $release_directory/Module-Releases/MyNewGitModule/
    Latest
    MyNewGitModule-R1-00
...
#    hey.txt
    ...
    * main
	...
	# Check remote branches of release R1-00a
    $ echo 'Repo release R1-00a remote branches='
    Repo release R1-00a remote branches=
    $ git -P -C $R1_00a_release_dir branch -r
...
#--------------------------------------------------------------------------------
    $ echo '====== CHECKING OUT SAVED MyNewGitModule main'
    ====== CHECKING OUT SAVED MyNewGitModule main
...
#--------------------------------------------------------------------------------
print('====== MODIFYING MyNewGitModule main trunk')
...
#add files to this branch in the sandbox
    ...
    [main *] Added heythere.txt to branch (glob)
...
#--------------------------------------------------------------------------------
    $ echo '====== RE-SAVING MyNewGitModule main trunk as R1-00b'
    ====== RE-SAVING MyNewGitModule main trunk as R1-00b
...
# run save command
    ...
    *  somedude (glob)
    ...
    \t    pyam: Add a R1-00b release note entry (esc)
    
    \tcommit * (esc) (glob)
    \tAuthor:* (esc) (glob)
    \tDate:   * (esc) (glob)
    
    \t    pyam: Update R1-00b revision tag (esc)
...
#--------------------------------------------------------------------------------
    $ echo '====== CHECKING OUT OLDER MyNewGitModule-R1-00b tagged module'
    ====== CHECKING OUT OLDER MyNewGitModule-R1-00b tagged module
 

    $ cd $sandbox_directory
    $ $PYAM scrap MyNewGitModule --remove

    $ $PYAM checkout MyNewGitModule  --release R1-00b --branch -
