...
"$PYAM" --quiet --release-directory="$release_directory" \
        --database-connection="127.0.0.1:$port/test" --default-repository-url="$fake_repository_url" rebuild 'Dshell++'
popd > /dev/null
...
# Do a clean check out of the same branched module to make sure changes are still there
