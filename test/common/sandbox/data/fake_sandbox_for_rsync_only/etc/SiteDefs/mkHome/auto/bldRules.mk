...
# extract the YamVersion information
...
CRLINKS ?= $(YAM_ROOT)/etc/SiteDefs/mkHome/shared/crlinks.pl
...
###########################
# FURTHER OPTIMIZATION - should fix up the rules below so that crlinks.sh is
#                        not run if no links need to be exported
###########################
...
exportmklinks = $(CRLINKS) $(YAM_ROOT) $(1) $(3)  $(CPLINKS) $(2)
...
define rmlinks-mod-TEMPLATE
  rmlinks-mod-$(1):
	...
	#$(CRLINKS) $(YAM_ROOT) $(LINKDIR_$(1)_LINKS) $(RELLNK_DIR) $($(1)_LINKS)
      endif
endef
